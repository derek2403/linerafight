...
const Landing: React.FC = () => {
    ...
    return (
        <div className="relative h-screen overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="z-10 text-center max-w-2xl px-4 mb-80">
                ...
                <p className="text-xl md:text-3xl text-black mb-12 font-['ThaleahFat'] tracking-wide drop-shadow-md">
                ...
                <div className="flex flex-col items-center gap-6">
                    <button
                        ...
                        className="px-12 py-6 bg-yellow-400 text-white font-['ThaleahFat'] text-4xl rounded-lg hover:bg-yellow-300 hover:scale-105 transition-all border-4 border-black active:translate-y-1"
                    >
                        PLAY NOW
                    </button>
                </div>
